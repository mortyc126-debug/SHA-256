...
2. Wang extension за r=17 (T_BARRIER_EQUALS_SCHEDULE — реальная стена).
3. Signal amplification у block-2 [IT-4.S4].
...
- **Extension Wang-chain за r=17** ?OPEN — T_BARRIER_EQUALS_SCHEDULE, реальная стена
- **Backward shortcut beyond ANF early-verify** ?OPEN — 7.6× пока потолок [§132/§133], **приоритет 1**
...
**Главный фокус** (по состоянию на апрель 2026, после scoping-сессии):
1. **Backward shortcut extension за пределы ANF early-verify (7.6×)** — оставшийся приоритет 1
2. Wang extension за r=17 (если есть идеи — T_BARRIER_EQUALS_SCHEDULE real)
3. Signal amplification у block-2 [IT-4.S4] — механизм изучен, можно использовать
...
- `FINDINGS.md`, `COHOMOLOGY_FINDINGS.md` — полные отчёты
