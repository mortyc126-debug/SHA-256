...
Партия 4 — IT-6b/6c + IT-7 collision probes + IT-8/IT-9 (cascade, full-SHA, twoblock).

После — Том I/II:
- [DOC] сверка ссылок (П-N, §N) между главами и исходниками.
- [PROOF] аудит центральных теорем (T_CASCADE_MAX, T_WANG_CHAIN, General
  Discrimination, Theorem 7, Birthday 2¹²⁸ 6-анализ).
- Red flag follow-up (§130→§133, height_2 progression, T_SHA512_SPECTRAL
  dual status).
