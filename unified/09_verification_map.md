...
| ~~**IT-6** Ω_3 = +0.98, 240/256 same-sign, p~10⁻⁵²~~ ⊘ROLL [Phase 8C audit 2026-04, UNIFIED §III.7]: RO=0.978 same protocol | `it6_full_output_map.py` + `phase8c_proper_audit.py` | `it6_full_output_map.json`, `phase8c_proper_audit.json` | ⊘ROLL |
| ~~**IT-6b** Ω_k spectrum~~ ⊘ROLL: same chi_arr artifact | `it6b_fast.py`, `it6b_omega_spectrum.py` | `it6b_omega_spectrum.json` | ⊘ROLL |
| ~~**IT-6c** cross-feature~~ ⊘ROLL: same chi_arr artifact | `it6c_cross_feature.py` | `it6c_cross_feature.json` | ⊘ROLL |
...
**Вывод по Тому III**: все ключевые числа (z, p, AUC, ~~Ω_3, 240/256~~ [⊘ROLL §III.7], τ≈1.80,
...
6. ~~**IT-6 ρ=+0.98**: самый сильный сигнал всей программы (p~10⁻⁵²). Независимая репликация на других random seeds для RO null обязательна.~~ ⊘ROLL [Phase 8C 2026-04, UNIFIED §III.7]: RO replication с правильным protocol дал Ω=0.978 — artifact. IT-6 "strongest signal" — chi_arr-basis illusion.
